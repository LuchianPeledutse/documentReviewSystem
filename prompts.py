...
def suggestions_based_on_technologies(text: str) -> str:
    the_prompt = f"""
    Задача: по технологиям, которые упомянуты внизу дать предложения по возможным темам, которые стоит изучить для более глубокого понимания
    Технологии: {text}
    Формат ответа: ответ должен быть в форме пронумерованного списка, который имеет не более 5 элементов
    Примеры:
    Технологии - recall, sparse retriever, QA pipeline, BM25, DPR
    Ответ:
    1. Основные метрики классического машинного обучения для разных задач (классификации, ранжирования)
    2. Способы векторизации текста. Основные методы обработки естественного языка. Задачи RAG, text classification, NER 
    ---
    Технологии - scikit-learn, XGBoost, TensorFlow, PyTorch
    Ответ:
    1. Основные модели классического машинного обучения. Линейная регрессия, логистичиская регрессия, градиентный бустинг,
    деревья решений.
    2. Глубокое обучение. алгоритмы обратного распространения ошибки. Основные модели и задачи глубокого обучения.
    3. Основные технологии и библиотеки для обучения нейронных сетей. Отличия библиотек обучения нейронных сетей.
    Чего не делать: Давать слишком длинные предложения. Писать что-то кроме нужного пронумерованного списка. Писать слово "Ответ"
    """
    return the_prompt
